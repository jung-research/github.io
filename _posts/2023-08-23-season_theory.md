...
* how
  ...
  1.  금리 인하
      ...
      - 단기:
        ...
        [MMF](/2023/08/27/economics_noun.html#mmf) 나 CMA[^3] 처럼 단기 투자자산에서 대기자산 형태로 몰려있다
      ...
      Q[^4]: 금리의 조정은 각 나라별 이고, 페그제(peg system) 고정환율제로 금리가 동시에 등락하지 않은 이상, 투자자 외국유출?

  2. SOC[^5] 확충을 통한 투자 확대
